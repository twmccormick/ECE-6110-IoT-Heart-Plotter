    ...
    while (bytesLeftToRead > 0)
    {
      ...
      while (toGet > 0)
      {
        ...
        if (activeLEDs > 1)
        {
          ...
          //uint8_t newData2[3] = {0};

          //readMult(MAX30105_READ_ADDRESS, MAX30105_FIFODATA, newData2, (uint16_t)3);
        ...
        if (activeLEDs > 2)
        {
          //Burst read three more bytes - Green
        	//uint8_t newData3[3] = {0};

        	//readMult(MAX30105_READ_ADDRESS, MAX30105_FIFODATA, newData3, (uint16_t)3);
